    ...
    <section>
        <article>
            <div class="portfolio">
                ...
                <button class="btn btn-outline-primary" onclick="location.href='${pageContext.servletContext.contextPath}/subject'">기업과제</button>
            <button class="btn btn-primary" onclick="location.href='${pageContext.servletContext.contextPath}/subject/apply'">제출과제</button>
            </div>
            <script>
                $(function(){

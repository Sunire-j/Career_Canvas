    ...
    <section>
        <article class="container" style="margin-top: 100px; border-top: 3px solid #73351F; border-bottom: 2px dashed #73351F; padding: 0px">
            ...
            <div class="portfolio">
                ...
                <button class="btn btn-secondary" onclick="location.href='${pageContext.servletContext.contextPath}/subject'">기업과제</button>
          ...
          <div style="width: 100%; text-align: center;">
            <div class="search-container" style="margin: 30px;">
              <form action="${pageContext.servletContext.contextPath}/subject" class="d-flex board-bottom" method="get">
                  ...
                  <input type="text" class="form-control" name="searchWord" placeholder="검색어를 입력하세요" style="margin-right: 10px" maxlength="80">

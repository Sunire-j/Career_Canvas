    ...
    <section>
        <article>
            <div class="portfolio">
                ...
                <button class="btn btn-primary" onclick="location.href='${pageContext.servletContext.contextPath}/subject'">기업과제</button>
                <button class="btn btn-outline-primary" onclick="location.href='${pageContext.servletContext.contextPath}/subject/apply'">제출과제</button>
            </div>
            <!-- 리스트 레이아웃 -->
          ...
          <div class="paging_wrapper" style="text-align: center;">
            ...
            <c:if test="${pVO.totalRecord > 0}">
              ...
              <c:if test="${pVO.page > 1}">
                  ...
                  <a
                    href="${pageContext.servletContext.contextPath}/subject?page=${pVO.page - 1}
              ...
              <c:if test="${p <= pVO.totalPage}">
                ...
                <a
                href="${pageContext.servletContext.contextPath}/subject?page=${p}&searchWord=${pVO.searchWord}">

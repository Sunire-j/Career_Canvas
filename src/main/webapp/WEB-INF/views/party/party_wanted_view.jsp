                    ...
                    success: function (result) {//리절트는 commentvo 리스트에 담겨서
                        ...
                        for (var i = 0; i < result.length; i++) {
                            ...
                            if('${LogId}'==comment.user_userid){
                                htmltag+='<div id="commentedit" title="'+comment.commentid+'" style="cursor: pointer; display: inline-block; font-size: 14px; color: white" >수정</div>';
                            }
            ...
            $(function () {
                ...
                $(".comment_list_real").on('click', '#commentedit', function() {
                    ...
                    if($(this).text()=='완료'){
                        ...
                        $.ajax({
                            url:"${pageContext.servletContext.contextPath}/comment/editcommentWanted",
                            data:{
                                commentid : editid,

        ...
        <article>
            ...
            <div class="portfolio">
                ...
                <div style="display: flex; padding: 5px 20px 20px 20px; gap: 10px;">
                  ...
                  <button class="btn btn-primary">개인</button>
                <button class="btn btn-outline-primary" onclick="location.href='${pageContext.servletContext.contextPath}/pofol_preview/team'">팀</button>
              </div>

            ...
            <div style="background: #D9D9D9;">
                <div class="d-flex" style="display: flex; padding: 5px ;height: 50px;display: flex; margin: 10px; justify-content: space-between">
                    ...
                    <div style="justify-content: center; text-align: center; width: 30%">
                        <button class="btn btn-secondary" style="margin-right: 20px">개인</button>
        ...
        <div style="padding: 20px 40px 40px 40px">
            ...
            <div style="width: 100%; text-align: center;">
                <div class="search-container">
                    <form action="${pageContext.servletContext.contextPath}/pofol_preview" class="d-flex board-bottom"
                          method="get">
                        ...
                        <input type="text" class="form-control" name="searchWord" placeholder="검색어를 입력하세요" maxlength="30"

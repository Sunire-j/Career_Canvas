            ...
            <div style="padding: 20px 40px 20px 40px">
                <div class="portfolio">
                    ...
                    <div style="display: flex; padding: 5px 20px 20px 0px; gap: 10px;">
                      ...
                      <button class="btn btn-secondary">개인</button>
                    <button class="btn btn-outline-secondary" onclick="location.href='${pageContext.servletContext.contextPath}/pofol_preview/team'">팀</button>
                  </div>
                </div>
            </div>
        </article>
        <div class="container"  style="padding: 0px; border-bottom: 3px solid #73351F;">
            <div style="padding: 20px 40px 40px 40px">
                ...
                <div class="search-container">
                  <form action="${pageContext.servletContext.contextPath}/pofol_preview" class="d-flex board-bottom" method="get">
      ...
      $(function(){
        $('#category').val(${pVO.category});
            ...
            $("#postSort").change(function () {
                ...
                window.location.href = "${pageContext.servletContext.contextPath}/pofol_preview?category=${pVO.category}&postSort=" + sortvalue + "&searchKey=${pVO.searchKey}&searchWord=${pVO.searchWord}";
            });
      });
    </script>
</body>

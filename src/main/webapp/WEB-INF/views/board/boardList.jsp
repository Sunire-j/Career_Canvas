        ...
        <div class="board-container-set">
            <div class="board-header">
                <div class="header-row">
                    ...
                    <div id="view" style="width: 7%" class="list"><i class="fa-solid fa-eye"
                                                                     style="color: #0d0d0d;"></i></div>
                    <div id="comment" style="width: 7%" class="list"><i class="fa-regular fa-comment-dots"
                                                                        style="color: #0d0d0d;"></i></div>
                    <div id="like" style="width: 7%" class="list"><i class="fa-solid fa-heart"
                                                                     style="color: #0d0d0d;"></i></div>
            ...
            <div class="search-container">
                <form action="${pageContext.request.contextPath}/board/${boardcat}" class="d-flex board-bottom"
                      method="get">
            ...
            <div style="display: flex; justify-content: space-between">
                            ...
                            <c:forEach var="i" begin="${pVO.startPage}" end="${pVO.startPage + pVO.onePageCount - 1}">
                                <c:if test="${i <= pVO.totalPage}">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <strong class="btn btn-outline-secondary"
                ...
                <a style="margin-top: 20px; color: white"
                   href="${pageContext.servletContext.contextPath}/board/${boardcat}/write" class="btn btn-secondary">글
                    작성</a>
            </div>
        </div>

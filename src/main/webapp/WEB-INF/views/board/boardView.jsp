    ...
    <section style="padding: 20px">
        ...
        <div class="board_main">
            ...
            <div class="board_content">
                ...
                <div class="content_recommend" style="
                width: 100%;
                display: flex;
              ...
              ">
                    ...
                    <div class="d-flex" style="margin-right: 10px; width: 300px">
                        ...
                        <c:if test="${LogId==bvo.user_userid}">
                            ...
                            >게시글 삭제</a
                            >
                            <a href="${pageContext.servletContext.contextPath}/board/edit?no=${bvo.postid}"
                               style="height: fit-content; margin-left: 10px;" class="btn btn-outline-dark btn-sm">게시글
                                수정</a>
                        </c:if>
                    </div>
                </div>

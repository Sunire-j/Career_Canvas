    ...
    <script>
        $(function () {
            ...
            $("#findidForm").on('change', function () {
                if ($('input[name="userEmail"]').hasClass('is-valid') && $('input[name="userid"]').hasClass('is-valid')) {
    ...
    <form method="post" id="findidForm" action="${pageContext.servletContext.contextPath}/findpwStart" class="needs-validation" name="findidForm" novalidate>
        ...
        <div style="width: 60%; margin: 10px auto 0;">
            <div>
                ...
                <div class="invalid-feedback" data-feedback="patternMismatch">아이디 형식에 맞지 않습니다.
                </div>
            </div>
            <div>
            ...
            <div class="mt-3" id="btngroup" style="display: flex; justify-content: space-between">
                <button type="submit" id="submitbtn" class="btn btn-primary" disabled>비밀번호 찾기</button>

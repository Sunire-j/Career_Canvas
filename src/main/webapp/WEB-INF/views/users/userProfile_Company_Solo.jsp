            ...
            <div class="portfolio">
                <div class="portfolio_category">
                    <button class="btn btn-outline-secondary"
                            onclick="location.href='${pageContext.servletContext.contextPath}/profile/portfolio?uid=${uVO.userid}'">
                        포트폴리오
                    </button>
                    <button class="btn btn-secondary"
                            onclick="location.href='${pageContext.servletContext.contextPath}/profile/subject/solo?uid=${uVO.userid}'">
                        기업과제
                    </button>
                </div>
                <div class="solo_party">
                    ...
                    <div class="solo_party_btn" style="margin-top: 20px">
                        ...
                        <button class="btn btn-outline-success"
                                onclick="location.href='${pageContext.servletContext.contextPath}/profile/subject/party?uid=${uVO.userid}'">
                            파티
                        </button>
                    </div>
                    <div></div>
                            ...
                            <ul class="pagination justify-content-center d-flex">
                                <c:if test="${PagingVO.page > 1}">
                                    <li class="page-item"><a class="page-link"
                                                             href="?page =${PagingVO.page - 1}&uid=${uVO.userid}"><
                                    </a></li>
                                </c:if>
                                <c:forEach var="i" begin="${PagingVO.startPage}"
                                           end="${PagingVO.startPage + PagingVO.onePageCount - 1}">
                                    <c:if test="${i <= PagingVO.totalPage}">
                                        <c:choose>
                                            <c:when test="${i != PagingVO.page}">
                                                <li class="page-item"><a class="page-link"
                                                                         href="?page=${i}&uid=${uVO.userid}
                                                    ">${i}</a></li>
                                            </c:when>
                                            <c:otherwise>

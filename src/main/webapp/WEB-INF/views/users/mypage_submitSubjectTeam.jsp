    ...
    <main  class="container" style="margin-top: 100px; border-top: 3px solid #73351F; padding: 0px; background: linear-gradient( to bottom, #D9C8A9 70%, #F2F2F2 );">
      ...
      <div class="button" >
        <div class=" mt-3" style="text-align: center; display:flex; gap: 20px; justify-content: center;" >
          <button
            class="btn btn-outline-secondary sendMsg"
      ...
      <div class="paging_wrapper" style="margin: 0 auto;">
        ...
        <ul class="paging">
          ...
          <c:if test="${pVO.page > 1}">
            <li>
              <a
                href="${pageContext.servletContext.contextPath}/mypage/submitSubjectTeam?page=${pVO.page - 1}
          ...
          <c:if test="${p <= pVO.totalPage}">
            <li>
            <a
            href="${pageContext.servletContext.contextPath}/mypage/submitSubjectTeam?page=${p}&searchWord=${pVO.searchWord}">

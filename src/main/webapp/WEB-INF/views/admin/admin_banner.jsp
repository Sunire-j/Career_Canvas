...
<div style="display: flex">
    ...
    <div style="margin-left: 250px; width: 100%; height: 100%; padding: 20px">
        ...
        <table class="table table-hover">
            ...
            <c:forEach var="bannerVO" items="${bannerVO}">
                ...
                <td><a class="btn btn-sm btn-primary"
                       onclick="window.open('${pageContext.servletContext.contextPath}/admin/banner/check?bannerid=${bannerVO.bannerid}')">확인</a></td>
                ...
                <td>
                    ...
                    <button onclick="dueDelete(${bannerVO.bannerid})" class="btn btn-sm btn-danger" style="margin-left: 10px"
                            id="expireDelete${bannerVO.bannerid}">만료삭제
                    </button>
                    <script>
        ...
        <div style="width: 100%; text-align: right;">
            <input type="button" class="btn-primary btn" value="배너 추가"
                   onclick="location.href='${pageContext.servletContext.contextPath}/admin/banner/add'">
        </div>
        <!-- 페이징 -->
        <div>
